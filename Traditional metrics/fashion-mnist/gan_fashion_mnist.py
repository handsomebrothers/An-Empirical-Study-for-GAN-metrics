...
class GAN():
    ...
    def sample_images(self, epoch, global_step):
        ...
        if not os.path.isdir('images_gan_fashion_mnist'):
            os.mkdir('images_gan_fashion_mnist')
        fig.savefig("images_gan_fashion_mnist/epoch_%d_step_%d.png" % (epoch, global_step))
        plt.close()
