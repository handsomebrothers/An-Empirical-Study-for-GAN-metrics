...
def classifier_logits(images, classifier_fn, num_batches=1):
  ...
  # print((tf.Session().run(logits)))

  return logits
def mnist_logits(images, graph_def_filename=None, input_tensor=INPUT_TENSOR,
  ...
  # print(tf.Session().run(mnist_classifier_fn))


  logits = classifier_logits(
      images, mnist_classifier_fn, num_batches)
  # print('---score----::'+str(tf.Session().run(score)))
