...
class BGAN():
    ...
    def metrics(self, epoch, X_test, sampleSize):
        ...
        x_real_loader = Data.DataLoader(dataset=x_dataset, batch_size=128, shuffle=True)
        x_fake_dataset = MyDataset(gen_imgs)
        x_fake_loader = Data.DataLoader(dataset=x_fake_dataset, batch_size=128, shuffle=True)
